...
export const config = {
  matcher: [
     ...
     *   - sw.js            (service worker — fetched on every nav/update
     *                       check; no need to auth-refresh it)
     ...
     */
    '/((?!_next/static|_next/image|favicon.ico|icon.svg|sw.js|apple-touch-icon.png|manifest.webmanifest|.*\\.(?:svg|png|jpg|jpeg|gif|webp|woff|woff2|ttf)$).*)',
  ],
};
